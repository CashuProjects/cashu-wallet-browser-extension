...
const passwordErrors: Record<string, React.ReactNode> = {
    ...
    "<span className=\'font-medium\'>Try a combo stronger than Goku!</span> Password must be at least 8 characters long, include at least one capital letter, number, and symbol.",
    passwordConfirmationErrorMessage: "<span className=\'font-medium\'>Matte Kudasai!</span> Your passwords are like apples and oranges – Please make sure they match!'",
};
  ...
  function onchange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    return (
      <form onSubmit={onsubmit}>
        ...
        <div className="">
        <PasswordInput labelText='Confirm your password' name='confirm-password' onChange={onchange} onBlur={validate} />
